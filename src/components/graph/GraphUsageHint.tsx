...
export function GraphUsageHint() {
  ...
  return (
    <div className="pointer-events-auto absolute bottom-4 left-1/2 z-10 max-w-md -translate-x-1/2 px-4">
      <div className="flex items-start gap-3 rounded-lg border border-slate-200 bg-white/95 px-3 py-2 text-xs text-slate-700 shadow-lg backdrop-blur dark:border-slate-700 dark:bg-slate-950/95 dark:text-slate-200">
        <Lightbulb
        ...
        <button
          type="button"
          className="shrink-0 rounded p-1 text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800"
          onClick={dismiss}
